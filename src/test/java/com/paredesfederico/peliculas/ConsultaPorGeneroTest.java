...
public class ConsultaPorGeneroTest {
	  ...
	  @Test
	  public void validarConsultaPorGenero() throws IOException {
		 ...
		 String[] paths = {"./resources/TheLovelyBones.jpg","./resources/VanillaSky.jpg","./resources/Orphan.jpg",
			...
			assertThat(generosGuardados.size()).isEqualTo(6);
		  
		     Genero generoBuscado = generoRepository.findByNombreGenero("Drama");
		     
		     List<Pelicula> peliculasBuscadas = generoBuscado.getPeliculas();
		     
		     assertThat(peliculasBuscadas.size()).isEqualTo(2);
